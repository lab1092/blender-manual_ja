...
:doc:`Output panel </render/output>` of the :doc:`Render context </interface/contexts>` window.
...
defined in the Frame Range of the Dimensions panel, :doc:`Render context </interface/contexts>`.
