...
..    Comment: <!--
   ...
   [[File:25-Manual-Lighting-Lamps-Spot-RayPanel.png|thumb|306px|{{Literal|Shadow}} panel set to {{Literal|Ray Shadow}}]]
   ...
   The raytraced shadows settings of this lamp are shared with other ones, and are described in [[Doc:2.5/Manual/Lighting/Shadows/Raytraced Properties|Raytraced Properties]].
   {{clr}}
