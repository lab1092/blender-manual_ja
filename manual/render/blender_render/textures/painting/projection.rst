...
(see :doc:`UV Mapping </render/blender_render/textures/mapping/uv>` for more details), so if the model hasn't been unwrapped yet,
it should be unwrapped prior to entering *Texture Paint* mode.
