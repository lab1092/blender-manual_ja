...
(as described in the section on :doc:`arranging frames </getting_started/basics/interface/window_system/arranging_frames>`).
...
Window/Editor Type Selector
   The red shaded area allows you to change the :doc:`Window/Editor Type </getting_started/basics/interface/window_types>`.
...
Viewport Shading
   ...
   You can select the type of :doc:`Viewport shading </getting_started/basics/navigating/3d_view_options#view_shading>`
