...
- Select only the future owner, hit :kbd:`Ctrl-Shift-C`, and in the *Add Constraint to New Empty Object* menu that pops up, select the constraint you want to add. If the chosen constraint needs it, a new *Empty* object will be automatically added as target, positioned at the owner's center, and with null rotation.
- Select first the future target, and then the future owner, hit :kbd:`Ctrl-Shift-C`, and in the *Add Constraint to Active Object* (or *Add Constraint to Active Bone*) menu that pops up, select the constraint you want to add. If the chosen constraint needs it, the other selected object/bone will be used as target.
